...
- [ ] `sobre.html`: decidir se vira página 100% comercial/sobre mim ou se fica como currículo alternativo.
- [ ] `luiz.html`: manter disponível, isolado, sem excluir; revisar depois se entra no menu público ou área logada.
